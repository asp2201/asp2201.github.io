...
## Highlights
- **Sulfur isotopes & subduction:** resolving the “sulfur isotope discrepancy” and what it implies for sulfur inputs/outputs in arcs.
- **Eruptions & climate:** multidisciplinary constraints on stratospheric sulfur injection and forcing (e.g., Okmok II, 43 BCE).
- **IODP Expedition 398 (Hellenic Arc):** using submarine drill cores to extend eruption records and constrain volatile budgets.
